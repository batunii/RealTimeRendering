...
int main() {
    ...
    TextureClass checkTexture("./checkered-tile-floor/textures/floor-diffuse-texture.png");
    ...
    ImGui::ListBox("Choose mag mode", &selectedMagConfig,
                   &mipmap_mag_list[0], 2);
    ImGui::End();
    glfwGetFramebufferSize(window, &fbWidth, &fbHeight);
        ...
        checkTexture.change_mipmap(min, GL_LINEAR); 
        checkTexture.bind();
        checkeredShader.use();
